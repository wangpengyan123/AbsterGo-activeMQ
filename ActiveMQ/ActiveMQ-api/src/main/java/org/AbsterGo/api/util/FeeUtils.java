...
public class FeeUtils {
	 ...
	 * @return
	 */
	public static List<double[]> generateRepayFeeByDEBX(double account , int month , double yearInterest , int bit){
	 ...
	 * @return
	 */
	public static List<double[]> getRepayDQHB(double account , int month , double yearInterest , int bit){
		if(account <= 0 || month <= 0){
			throw new IllegalArgumentException("计算等额本息错误 : " + account + " , " + month);
		}
		double monthInterest = yearInterest / 12/100;
	 ...
	 * @return
	 */
	public static List<double[]> generateRepayFeeByFXHB(double account , int month , double yearInterest , int bit){
		if(account <= 0 || month <= 0){
			throw new IllegalArgumentException("计算等额本息错误 : " + account + " , " + month);
		}
		//月利率
